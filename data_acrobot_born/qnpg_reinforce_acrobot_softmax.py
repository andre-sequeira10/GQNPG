...
class policy_estimator_q(nn.Module):        
    ...
    #def forward(self, state):
        ...
        if policy == "Q":
            ...
            action_probs = F.softmax(beta*action_p, dim=-1)
                ...
                if batch_counter == batch_size:
                    ...
                    def closure():
                        ...
                        if ng:
                            ...
                            qfim = compute_qfim(mean_state,w,beta)
                            return loss, qfim
                        else:
                            return loss
...
if __name__ == '__main__':
    ...
    np.save("acrobot_softmax_{}_NG_ - {} || {}.npy".format(filename_save,ng,str(processid)), rewards_q)
    np.save("acrobot_softmax_{}_NG_grads_norm - {} || {}.npy".format(filename_save,ng,str(processid)), grads_q)
    np.save("acrobot_softmax_{}_NG_vars - {} || {}.npy".format(filename_save,ng,str(processid)), vars)
