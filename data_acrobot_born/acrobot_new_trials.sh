...
for j in $(seq 1 $M); do
    ...
    python qnpg_reinforce_acrobot_softmax.py --init zeros --policy Q --ng 1 --n_layers 4 --episodes 500 --entanglement all2all --batch_size 10 --filename_save "qfim_block_diag"& #--lr 0.02&
    job_pool+=("$!")
...
for j in $(seq 1 $M); do
    ...
    # Run the Python script as a background job and get its PID
    python qnpg_reinforce_acrobot_softmax.py --init zeros --policy Q --ng 1 --n_layers 4 --episodes 500 --entanglement all2all --batch_size 10 --filename_save "qfim_4"& #--lr 0.02&
    job_pool+=("$!")
