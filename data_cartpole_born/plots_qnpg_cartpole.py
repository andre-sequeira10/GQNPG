...
# Load data qfim
for np_name in glob.glob('cartpole_qfim_nNG_ - 1*'):
    reward_qfim.append(np.load(np_name))
for np_name in glob.glob('cartpole_qfim_nNG_grads_norm*'):
    grad_qfim.append(np.load(np_name))
for np_name in glob.glob('cartpole_qfim_nNG_vars*'):
    var_qfim.append(np.load(np_name))

# Load data qfim_half
for np_name in glob.glob('cartpole_qfim_half_nNG_ - 1*'):
    reward_qfim_half.append(np.load(np_name))
for np_name in glob.glob('cartpole_qfim_half_nNG_grads_norm*'):
    grad_qfim_half.append(np.load(np_name))
for np_name in glob.glob('cartpole_qfim_half_nNG_vars*'):
    var_qfim_half.append(np.load(np_name))

# Load data fim
for np_name in glob.glob('cartpole_fim_nNG_ - 1*'):
    reward_fim.append(np.load(np_name))
for np_name in glob.glob('cartpole_fim_nNG_grads_norm*'):
    grad_fim.append(np.load(np_name))
for np_name in glob.glob('cartpole_fim_nNG_vars*'):
    var_fim.append(np.load(np_name))

# Load data qfim block_diag
for np_name in glob.glob('cartpole_qfim_block_diag_nNG_ - 1*'):
    reward_qfim_block_diag.append(np.load(np_name))
for np_name in glob.glob('cartpole_qfim_block_diag_nNG_grads_norm*'):
    grad_qfim_block_diag.append(np.load(np_name))
for np_name in glob.glob('cartpole_qfim_block_diag_nNG_vars*'):
    var_qfim_block_diag.append(np.load(np_name))

#load data adam
for np_name in glob.glob('cartpole_adao_nNG_ - 0*'):
    reward_adam.append(np.load(np_name))
for np_name in glob.glob('cartpole_adao_nNG_grads_norm*'):
    grad_adam.append(np.load(np_name))
for np_name in glob.glob('cartpole_adao_nNG_vars*'):
